          ...
          <div className="col-span-1 lg:col-span-2">
            <div className="mb-8">
              ...
              <p className="text-sm mb-4">
                Language: 
                <button onClick={() => setLanguage('jp')} className={`ml-2 ${language === 'jp' ? 'text-blue-400 underline' : 'text-white'}`}>JP</button>
                /
                <button onClick={() => setLanguage('en')} className={`${language === 'en' ? 'text-blue-400 underline' : 'text-white'}`}>EN</button>
              </p>
            </div>
                  ...
                  {/* AccordionContentの中身 */}
                    <div className="space-y-2">
                      ...
                      <div className="grid grid-cols-6 gap-4  border-b border-gray-700">
                        ...
                        <Button size="sm" variant="ghost" className="w-full">preparation</Button>
                        </div>
                      </div>
                      <div className="grid grid-cols-6 gap-4  border-b border-gray-700">
                      <div className="col-span-2"></div>
